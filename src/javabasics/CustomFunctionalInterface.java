 ...
 * 
 * @author urmis
 * The Function interface takes a single input and produces an output, 
 * whereas the BiFunction interface takes two inputs and produces an output. 
 * if we need a function that takes three inputs, we must construct our own customized function.
 */
